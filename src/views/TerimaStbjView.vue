    ...
    showConfirmation(
        ...
        async () => {
            try {
                ...
                toast.error(error.response?.data?.message || 'Gagal membatalkan penolakan.');
            }
        }
    );
};
    ...
    <PageLayout title="Browse Terima STBJ" icon="mdi-truck-check-outline">
        ...
        <div class="browse-content">
            <div class="filter-section">
                ...
                <v-text-field v-model="filters.endDate" type="date" density="compact" hide-details variant="outlined"
                    style="max-width: 180px;" />
                <v-text-field label="Gudang" v-model="filters.gudang" density="compact" hide-details readonly
        ...
        <v-dialog v-model="dialogConfirm.show" max-width="400px" persistent>
            <v-card>
                ...
                <v-card-text v-html="`Anda yakin ingin ${dialogConfirm.text}`"></v-card-text>
                <v-card-actions>
                    <v-spacer />

      ...
      <div class="filter-section px-2">
        <div class="d-flex align-center ga-1" style="flex-wrap: nowrap">
          ...
          <v-select
            ...
            variant="outlined"
            class="cabang-select"
            :menu-props="{ class: 'so-filter-menu' }"
          />
        </div>
        ...
        <div class="legend-group d-flex align-center ga-1">
          <div class="legend-badge legend-open"><v-icon size="12">mdi-circle</v-icon> Open</div>
          <div class="legend-badge legend-proc"><v-icon size="12">mdi-circle</v-icon> Proc</div>
          <div class="legend-badge legend-part"><v-icon size="12">mdi-circle</v-icon> Part</div>
          <div class="legend-badge legend-lunas"><v-icon size="12">mdi-circle</v-icon> Lunas</div>
          <div class="legend-badge legend-jadi"><v-icon size="12">mdi-circle</v-icon> Jadi</div>
          <div class="legend-badge legend-dtf"><v-icon size="12">mdi-circle</v-icon> DTF</div>
          <div class="legend-badge legend-grey">
            <v-icon size="12">mdi-circle</v-icon> Pasif / Close
          </div>
        </div>
...
/* --- Search bar diperpanjang, samakan dengan OfferView (FIX flex-shrink total) --- */
.filter-section .so-search-field {
...
.filter-section .so-search-field :deep(.v-input__control) {
  width: 100% !important;
}

.filter-section .so-search-field :deep(.v-field) {
  width: 100% !important;
...
.filter-section .so-search-field :deep(.v-field__outline),
...
.filter-section .so-search-field :deep(.v-field--focused),
...
.filter-section .so-search-field :deep(.v-field__prepend-inner .v-icon) {
  color: #b71c1c !important;
  opacity: 1 !important;
}
...
<style>
.so-filter-menu .v-list-item--active {
  background-color: rgba(183, 28, 28, 0.1) !important;
  color: #b71c1c !important;
}
.so-filter-menu .v-list-item:hover {
  background-color: rgba(183, 28, 28, 0.06) !important;
}
</style>

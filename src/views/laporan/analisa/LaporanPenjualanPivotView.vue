...
const hotSettings = computed<ExtendedGridSettings>(() => {
  const settings: ExtendedGridSettings = {
    ...
    columns: [
      ...
      {
        data: 'Tanggal',
        renderer(instance: Handsontable.Core, td: HTMLTableCellElement, row: number, col: number, prop: string | number, value: unknown) {
          if (value) {
      ...
      { data: 'KdCus' } as ColumnLike, { data: 'Customer' } as ColumnLike, { data: 'Level_' } as ColumnLike, { data: 'Kode' } as ColumnLike,
      { data: 'Nama' } as ColumnLike, { data: 'Ukuran' } as ColumnLike, { data: 'Qty', type: NumericCellType } as ColumnLike,
      { data: 'Nominal', type: NumericCellType, numericFormat: { pattern: '0,0' } } as ColumnLike,
      { data: 'Store' } as ColumnLike, { data: 'NamaStore' } as ColumnLike, { data: 'KtgProduk' } as ColumnLike,
      { data: 'KtgBarang' } as ColumnLike, { data: 'JenisKain' } as ColumnLike, { data: 'Warna' } as ColumnLike,
    ],

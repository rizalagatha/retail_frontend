        ...
        <v-card class="desktop-form-section header-section" elevation="0">
          <v-card-text>
            <v-row dense>
              ...
              <v-col cols="6">
                <v-text-field label="Nomor Potongan" v-model="header.nomor" density="compact" :readonly="isEditMode"
                  @click="!isEditMode && handleNomorSearch()" prepend-inner-icon="mdi-magnify"
                  placeholder="F1 atau Klik..." hide-details class="mb-2" variant="outlined">
              ...
              <v-col cols="6">
                <v-text-field label="Kode Customer" v-model="header.customer.kode" density="compact"
                  ...
                  prepend-inner-icon="mdi-magnify" placeholder="F1 atau Klik..." hide-details variant="outlined" />
              </v-col>
              <v-col cols="6">
              ...
              <v-col cols="6">
                <v-text-field label="Alamat" v-model="header.customer.alamat" density="compact" readonly hide-details
                  variant="filled" />
              </v-col>
              <v-col cols="6">
                <v-text-field label="Kota" v-model="header.customer.kota" density="compact" readonly hide-details
                  variant="filled" />
              </v-col>
              <v-col cols="6">
                <v-text-field label="Telepon" v-model="header.customer.telp" density="compact" readonly hide-details
                  variant="filled" />
              </v-col>
              ...
              <v-col cols="6">
                <v-text-field id="edtNominal" label="Nominal Potongan (IDR)" v-model.number="header.nominalPotongan"
                  type="number" min="0" density="compact" :readonly="isEditMode" @blur="handleNominalExit" hide-details
                  variant="outlined" />
              </v-col>
              <v-col cols="6">
                <v-text-field label="Kode Akun" v-model="header.akun.kode" density="compact" readonly hide-details
                  variant="filled" />
              </v-col>
              <v-col cols="6">
              ...
              <v-col cols="12">
                <v-text-field label="Nama Akun" v-model="header.akun.nama" density="compact" readonly hide-details
                  variant="filled" />
              </v-col>
            </v-row>
          </v-card-text>
        ...
        <v-card class="desktop-form-section footer-section mt-4" elevation="2">
          ...
          <v-card-text>
            <v-text-field label="Total Potongan Dialokasikan"
              :model-value="header.totalTerbayar.toLocaleString('id-ID')" readonly variant="filled" density="compact"
              hide-details class="text-right font-weight-bold text-h6 summary-field"></v-text-field>
              ...
              <tr>
                <td colspan="11">
                  <div class="pa-2 d-flex justify-end">
                    <v-btn v-if="!isEditMode && items.some(i => i.invoice === '')" color="primary"
                      prepend-icon="mdi-plus" @click="addNewRow">
                      Tambah Baris
                    </v-btn>
                  </div>
                </td>
...
.form-grid-container {
  ...
  /* Kolom kiri tetap, kolom kanan mengisi sisa */
  gap: 16px;
  height: 100%;
}

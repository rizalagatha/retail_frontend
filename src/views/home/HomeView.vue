...
<template>
  ...
  <v-container v-else class="home-container pa-0" fluid>
    ...
    <div class="dashboard-content px-6 mt-n8 position-relative" style="z-index: 2;">
      ...
      <v-row v-if="promoText" class="mb-6">
                  ...
                  <tr v-for="(item, index) in branchPerformances" :key="item.kode_cabang">
                    ...
                    <td class="text-right">
                      <div class="d-flex align-center justify-end ga-2">
                        ...
                        <v-progress-circular :model-value="item.ach" :color="getAchColor(item.ach)" size="20" width="3"
                          bg-color="grey-lighten-2"></v-progress-circular>
                      </div>
                    </td>
                  </tr>
...
.promo-ticker-container {
  ...
  height: 32px;
  /* Tinggi dikurangi dari 40px ke 32px agar tidak terlalu besar */
  margin-top: 4px;
}

    ...
    <PageLayout title="Setting Tanggal Stok Opname" :menu-id="MENU_ID">
        ...
        <div class="browse-content">
            <div class="table-container">
                <v-data-table v-model="selected" :headers="headers" :items="items" :loading="isLoading"
                    class="desktop-table" density="compact" fixed-header item-value="tanggal" return-object
                    single-select>
        ...
        <v-dialog v-model="dialogSetting.show" max-width="400px" persistent>
            <v-card>
                ...
                <v-card-text>
                    <v-text-field v-model="dialogSetting.tanggal" type="date" label="Tanggal" variant="outlined"

                                ...
                                <div class="detail-container">
                                    ...
                                    <div v-else class="detail-wrapper">
                                        ...
                                        <v-data-table :headers="detailHeaders" :items="details[item.nomor]"
                                            density="compact" class="desktop-table detail-table mb-4"
                                            :items-per-page="-1">
                                        ...
                                        <v-data-table :headers="paymentLinkHeaders" :items="paymentLinks[item.nomor]"
                                            density="compact" class="desktop-table detail-table" :items-per-page="-1">
                                            <template #item.tanggal="{ item }">{{ format(parseISO(item.tanggal),
                                                'dd/MM/yyyy') }}</template>
                                            <template #bottom></template>
                                        </v-data-table>
                                    </div>

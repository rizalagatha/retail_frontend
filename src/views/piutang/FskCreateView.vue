                ...
                <div class="desktop-form-section header-section">
                    <v-text-field label="Nomor" v-model="header.nomor" readonly filled density="compact" hide-details>
                        <template #append-inner><span v-if="!isEditMode"
                                class="text-caption">&lt;Baru&gt;</span></template>
                    </v-text-field>
                    <v-text-field label="Tanggal Setor" v-model="header.tanggal" type="date" variant="outlined"
                        density="compact" hide-details :readonly="isEditMode" />
                    <v-text-field label="Store" v-model="header.cabang" readonly filled density="compact"
                        hide-details />
                    <v-text-field label="Dibuat Oleh" v-model="header.dibuatOleh" readonly filled density="compact"
                        hide-details />
                    <v-text-field label="Total Nominal Setor" :model-value="formatRupiah(totalNominalSetor)" readonly
                        filled density="compact" hide-details />
                    <v-text-field v-if="isEditMode" label="Diverifikasi" v-model="header.diverifikasiOleh" readonly
                        filled density="compact" hide-details />
                    <v-text-field v-if="isEditMode" label="Tgl Verifikasi" v-model="header.tglVerifikasi" readonly
                        filled density="compact" hide-details />
                </div>

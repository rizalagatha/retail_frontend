...
const loadItemsFromSource = async (nomor: string) => {
  ...
  try {
    ...
    items.value = response.data.map((item: ItemResponse): Item => ({
      ...
      <div class="left-column">
        <div class="desktop-form-section header-section">
          <v-row dense>
            ...
            <v-col cols="12">
              <v-text-field label="Nama Gudang" v-model="header.gudang.nama" readonly filled density="compact"
                hide-details />
            </v-col>
            <v-col cols="12">
            ...
            <v-col cols="12">
              <v-text-field label="Nama Store" v-model="header.store.nama" readonly filled density="compact"
                hide-details />
            </v-col>
            <v-col cols="12">

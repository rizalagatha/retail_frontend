...
<template>
  <v-container fluid class="pa-0 fill-height login-wrapper">
          ...
          <div class="w-100" style="max-width: 400px">
            <div class="mb-10">
              ...
              <p
                ...
                :class="
                  theme.global.current.value.dark ? 'text-grey-lighten-1' : 'text-grey-darken-1'
                "
              >
            ...
            <v-form @submit.prevent="handleLogin">
              <div class="mb-5 input-group">
                <label
                  ...
                  :class="
                    theme.global.current.value.dark ? 'text-grey-lighten-2' : 'text-grey-darken-2'
                  "
                >
                  User ID
                </label>
              ...
              <div class="text-center mt-6">
                <v-btn
                  variant="text"
                  size="small"
                  class="text-caption hover-underline transition-colors"
                  :class="
                    theme.global.current.value.dark ? 'text-grey-lighten-1' : 'text-grey-darken-1'
                  "
                  to="/"
    ...
    <v-dialog
      v-model="isBranchDialogVisible"
      persistent
      max-width="400px"
      transition="dialog-bottom-transition"
    >
      <v-card class="rounded-lg elevation-12">
        <v-card-title class="text-h6 pt-6 px-6 font-weight-bold text-primary"
          >Pilih Lokasi Kerja</v-card-title
        >
        ...
        <v-card-actions class="px-6 pb-6 pt-0">
          <v-spacer></v-spacer>
          <v-btn variant="text" color="medium-emphasis" @click="isBranchDialogVisible = false"
            >Batal</v-btn
          >
          <v-btn
            color="primary"
            variant="elevated"
            class="px-6 btn-hover-effect"
      ...
      <v-card class="rounded-lg elevation-12 pa-4">
        ...
        <v-card-text>
          <p class="mb-6 text-body-1">
            Password Anda sudah digunakan lebih dari <strong>3 bulan</strong>. Demi keamanan, Anda
            diwajibkan membuat password baru.
          </p>

          <v-form @submit.prevent="handleChangePassword">
            <div class="mb-4">
              <label class="text-caption font-weight-bold mb-1 d-block text-uppercase ls-1"
                >Password Baru</label
              >
              <v-text-field
                v-model="newPassword"

...
const exportData = async (type: 'header' | 'detail') => {
    if (type === 'header') {
        ...
        XLSX.writeFile(XLSX.utils.book_new_append_sheet(worksheet, "Header"), "Export_TerimaRepair_Header.xlsx");
    } else if (type === 'detail') {
        try {
            ...
            XLSX.writeFile(XLSX.utils.book_new_append_sheet(worksheet, "Detail"), "Export_TerimaRepair_Detail.xlsx");
        } catch (error) {
...
<template>
    <PageLayout title="Browse Terima dari Gudang Repair" icon="mdi-wrench-check-outline">
        <template #header-actions>
            <v-btn size="small" color="primary" @click="handleTerima" :disabled="!canTerima">Terima</v-btn>
            <v-btn size="small" color="error" @click="handleBatalTerima" :disabled="!canBatalTerima">Batal
                Terima</v-btn>
            <v-menu offset-y>

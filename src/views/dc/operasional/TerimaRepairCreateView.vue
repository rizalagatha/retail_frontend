...
onMounted(async () => {
    ...
    try {
        ...
        // --- PERBAIKAN DI SINI ---
        allocationItems.value = data.detailItems.map((item: any) => ({
            ...item,
            id: Math.random(),
            kdc: 0,
            kbs: 0,
            ...
            <div class="left-column">
                <div class="desktop-form-section header-section">
                    <v-row dense class="compact-form">
                        <v-col cols="6"><v-text-field label="No. Terima" v-model="header.nomor" readonly
                                filled /></v-col>
                        <v-col cols="6"><v-text-field label="Tgl. Terima" v-model="header.tanggal" type="date"
                                variant="outlined" /></v-col>
                        <v-col cols="6"><v-text-field label="No. Kirim" v-model="header.nomorKirim" readonly
                                filled /></v-col>
                        <v-col cols="6"><v-text-field label="Tgl. Kirim" v-model="header.tanggalKirim" readonly
                                filled /></v-col>
                        <v-col cols="12"><v-text-field label="Dari Gudang" v-model="header.dariGudang" readonly
                                filled /></v-col>

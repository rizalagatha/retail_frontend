...
const allSections = {
  penjualan: {
    ...
    items: [
      {
        title: "Penawaran",
        description: "Buat penawaran harga untuk customer.",
      ...
      },
      {
        ...
        description: "Proses pengajuan harga khusus.",
      ...
      {
        title: "Setting Harga",
        description: "Persetujuan dan pengaturan harga dari pengajuan.",
      ...
      },
      {
        ...
        description: "Surat pesanan untuk produk DTF custom.",
      ...
      {
        title: "LHK Jasa",
        description: "Laporan hasil kerja untuk SO DTF pesanan.",
      ...
      {
        title: "Dasbor DTF",
        description: "Pantau proses kerja DTF secara visual.",
      ...
      {
        title: "SO DTF Stok",
        description: "Surat pesanan untuk produk DTF stok.",
      ...
      },
      {
        ...
        description: "Laporan hasil kerja untuk SO DTF stok.",
      ...
      {
        title: "Surat Pesanan",
        description: "Catat pesanan dari customer.",
      ...
      },
      {
        ...
        description: "Buat tagihan sementara sebelum pengiriman.",
      ...
      {
        title: "Invoice",
        description: "Buat tagihan resmi penjualan.",
  ...
  internal: {
    ...
    items: [
      {
        title: "Buffer Stok",
        description: "Atur batas minimum dan maksimum stok.",
        to: "/transaksi/internal/buffer-stok",
        icon: "mdi-database-outline",
      },
      {
        title: "Minta Barang ke DC",
        description: "Buat permintaan barang dari store ke DC.",
      ...
      },
      {
        ...
        description: "Proses penerimaan surat jalan dari DC.",
      ...
      },
      {
        ...
        description: "Proses pengembalian barang ke DC.",
      ...
      {
        title: "Koreksi Stok",
        description: "Penyesuaian jumlah stok secara manual.",
      ...
      },
      {
        ...
        description: "Buat permintaan barcode untuk produk baru.",
      ...
      {
        title: "Klerek",
        description: "Proses klerek atau rekapitulasi data.",
    ...
    items: [
      {
        ...
        description: "Kirim barang dari gudang ke bagian produksi.",
      ...
      },
      {
        ...
        description: "Terima barang jadi dari bagian produksi.",
      ...
      {
        title: "Mutasi Stok",
        description: "Pindah barang antar jenis stok internal.",
        to: "/transaksi/mutasi/stok",
        icon: "mdi-swap-vertical",
        menuId: "45",
      },
      {
        title: "Mutasi Antar Store (Kirim)",
        description: "Kirim barang dari satu store ke store lain.",
      ...
      },
      {
        ...
        description: "Terima barang dari store lain.",
    ...
    items: [
      {
        ...
        description: "Lihat daftar produk dengan stok tapi HPP nol.",
      ...
      },
      {
        ...
        description: "Atur tanggal cut-off untuk proses stok opname.",
      ...
      },
      {
        ...
        description: "Masukkan hasil perhitungan stok fisik.",
      ...
      },
      {
        ...
        description: "Proses perhitungan stok berdasarkan lokasi rak.",
      ...
      {
        title: "Cek Selisih",
        description: "Bandingkan hasil stok fisik dengan stok sistem.",
      ...
      {
        title: "Proses",
        description: "Lakukan proses finalisasi stok opname.",

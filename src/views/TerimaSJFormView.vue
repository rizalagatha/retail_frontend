            ...
            <div class="left-column">
                <div class="desktop-form-section header-section">
                    ...
                    <v-text-field label="Dari Gudang"
                        ...
                        density="compact" hide-details />
                    <v-textarea label="Keterangan" v-model="header.keterangan" rows="3" readonly filled
                        density="compact" hide-details />
                </div>
            </div>
                ...
                <div class="desktop-form-section d-flex flex-column fill-height">
                    <div class="scanner-wrapper">
                        <v-text-field v-model="scannedBarcode" label="Scan Barcode di Sini untuk Menambah Jumlah Terima"
                            variant="outlined" density="compact" prepend-inner-icon="mdi-barcode-scan" hide-details
                            clearable autofocus @keydown.enter.prevent="handleBarcodeScan"></v-text-field>
                    </div>

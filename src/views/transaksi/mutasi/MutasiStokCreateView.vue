...
const handleSave = () => {
  ...
  showConfirmation(
    "Konfirmasi Simpan",
    "Anda yakin ingin menyimpan data Mutasi Stok ini?",
    executeSave
  );
};
            ...
            <v-col cols="12">
              ...
              >
                <template #append-inner
                  ><span v-if="!isEditMode" class="text-caption">&lt;Otomatis&gt;</span></template
                >
              </v-text-field>
            </v-col>
            <v-col cols="12">

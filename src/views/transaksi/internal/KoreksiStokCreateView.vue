        ...
        <div class="form-grid-container">
            <div class="left-column">
                <div class="desktop-form-section header-section">
                    <v-row dense>
                        <v-col cols="12">
                            <v-text-field label="No. Koreksi" v-model="header.nomor" readonly filled hide-details
                                density="compact" />
                        </v-col>
                        <v-col cols="12">
                        ...
                        <v-col cols="12">
                            <v-text-field label="Gudang"
                                :model-value="`${authStore.user?.cabang} - ${authStore.user?.cabangNama}`" readonly
                                filled hide-details density="compact" append-inner-icon="mdi-magnify"

...
const summaryHeaders = [
  ...
  { title: 'Jumlah', key: 'jumlah' }, { title: 'Koli', key: 'koli' }, { title: 'Keterangan', key: 'keterangan' },
];
const detailHeaders = [
...
<template>
  <PageLayout title="Form Tolak STBJ" desktop-mode>
    <template #header-actions>
      <v-btn v-if="canInsert" size="small" color="primary" @click="save" :loading="isSaving">
        Simpan
      </v-btn>
      <v-btn size="small"
        ...
        <div class="desktop-form-section header-section">
          <v-row dense class="compact-form">
            <v-col cols="6"><v-text-field label="No. Tolak" v-model="header.nomor" readonly filled
                hide-details /></v-col>
            <v-col cols="6"><v-text-field label="Tgl. Tolak" v-model="header.tanggal" type="date" variant="outlined"
                hide-details :readonly="!canInsert" /></v-col>
            ...
            <v-col cols="4"><v-text-field label="Ke Gudang Prepare" v-model="header.gudangRepair" readonly filled
                hide-details /></v-col>
            <v-col cols="8"><v-text-field v-model="header.gudangRepairNama" readonly filled hide-details /></v-col>
            ...
            <v-col cols="6"><v-text-field label="Tgl. SJ Garmen" v-model="header.tanggalSjGarmen" type="date"
                variant="outlined" hide-details :readonly="!canInsert" /></v-col>
          </v-row>
        </div>
      </div>

...
.items-table .no { width: 4%; text-align: center; }
.items-table .kode { width: 15%; }
.items-table .nama { width: auto; }
.items-table .ukuran { width: 8%; text-align: center; }
.items-table .qty { width: 8%; text-align: right; }
.items-table .harga { width: 12%; text-align: right; }

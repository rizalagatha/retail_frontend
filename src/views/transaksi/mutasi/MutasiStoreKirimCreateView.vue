          ...
          <v-row dense>
            ...
            <v-col cols="12">
              <v-text-field label="Ke Store" v-model="header.storeTujuanKode" readonly
                @click="dialog.storeSearch = true" prepend-inner-icon="mdi-magnify" density="compact" hide-details
                variant="outlined" />
            </v-col>
            <v-col cols="12">
              <v-text-field label="Nama Store" v-model="header.storeTujuanNama" readonly filled density="compact"
                hide-details />
            </v-col>
            <v-col cols="12">

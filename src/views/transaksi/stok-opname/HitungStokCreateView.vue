        ...
        <div class="form-grid-container">
            <div class="left-column">
                <div class="desktop-form-section header-section">
                    ...
                    <v-text-field id="lokasi-field" v-model="form.lokasi" label="LOKASI" variant="outlined"
                        density="compact" class="mb-4" @blur="fetchScannedItems" @keydown.enter="focusBarcodeField()"
                        hide-details />
                    ...
                    <v-text-field label="Kode Barang" v-model="form.kodeBarang" readonly filled density="compact"
                        hide-details />
                    <v-text-field label="Nama Barang" v-model="form.namaBarang" readonly filled density="compact"
                        hide-details />
            ...
            <div class="right-column">
                <div class="table-container">
                    <v-data-table :headers="headers" :items="scannedItems" :loading="isLoading"

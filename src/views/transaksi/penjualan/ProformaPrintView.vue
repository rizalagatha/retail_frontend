    ...
    <div class="print-container">
        ...
        <div v-if="printData" class="page">
            ...
            <div class="info-grid">
                ...
                <div class="alamat"><span class="label">Alamat</span>: {{ printData.header.cus_alamat }},
                    {{ printData.header.cus_kota }}, {{ printData.header.cus_telp }}</div>
                <div><span class="label">Tanggal</span>: {{ format(parseISO(printData.header.tanggal), 'dd-MM-yyyy') }}
                </div>
                <div><span class="label">Tempo</span>: {{ printData.header.top }} hari / {{
                    format(parseISO(printData.header.tempo), 'dd-MM-yyyy') }}</div>
            </div>
                ...
                <div class="summary-box">
                    <table>
                        ...
                        <tr>
                            <td>PPN</td>
                            <td>:</td>
                            <td>{{ (printData.header.ppn / 100 * (printData.header.total -
                                printData.header.diskon)).toLocaleString('id-ID') }}</td>
                        </tr>
                        <tr>
                            <td>Netto</td>
                            <td>:</td>
                            <td>{{ (printData.header.total - printData.header.diskon + (printData.header.ppn / 100 *
                                (printData.header.total - printData.header.diskon))).toLocaleString('id-ID') }}</td>
                        </tr>
                        <tr>
                            <td>Biaya Kirim</td>
                            <td>:</td>
                        ...
                        <tr class="grand-total">
                            ...
                            <td>:</td>
                            <td>{{ (printData.header.total - printData.header.diskon + (printData.header.ppn / 100 *
                                (printData.header.total - printData.header.diskon)) + printData.header.biayakirim -
                                printData.header.dprp).toLocaleString('id-ID') }}</td>
                        </tr>
                    </table>
                </div>
            </div>

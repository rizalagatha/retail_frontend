  ...
  <PageLayout title="Browse Promo" icon="mdi-gift-outline">
    ...
    <div class="browse-content">
      ...
      <div class="table-container">
        <AppDataTable v-model="selected" :headers="headers" :items="filteredList" :loading="loading"
          :item-class="getRowTextColor" item-value="nomor" density="compact" class="desktop-table header-browse-blue"
          fixed-header show-select return-object single-select @click:row="handleRowClick">
          <template #headers="{ columns, isSorted, getSortIcon, toggleSort }">
            <tr>
              <template v-for="header in columns" :key="header.key">
                <th v-if="header.key === 'data-table-select'" :style="{ width: header.width + 'px' }"
